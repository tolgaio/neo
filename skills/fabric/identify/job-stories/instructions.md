<!-- Fabric pattern: https://github.com/danielmiessler/Fabric/blob/main/data/patterns/identify_job_stories/system.md -->
...
4. PLAN: When dependencies are clear, I want to create a realistic timeline, so that I can set appropriate expectations with stakeholders.

---
# OUTPUT INSTRUCTIONS

For each job story, provide:
1. The complete job story following the format
2. A brief context note if the connection might not be immediately obvious

Group related job stories where appropriate to show workflows or related needs.
